...
import { ArrowLeft, Users, MessageSquare, UserCircle, Shield, UsersRound, Briefcase, Calendar, Newspaper, MapPin, Heart, Rocket, Menu } from 'lucide-react';
...
import { RelocationAssistant } from './RelocationAssistant';
import { DonationsGiving } from './DonationsGiving';
import { StartupHub } from './StartupHub';
...
export function V2App({ userRole, onBack }: V2AppProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">V2 • Ecosystem Expansion</p>
              </div>
            </div>
            {/* Mobile Menu Toggle */}
